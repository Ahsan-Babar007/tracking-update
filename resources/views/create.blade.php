...
<body>
  ...
  <form id="createTrackingForm">
    ...
    <input type="text" id="origin_state" name="origin_state" required placeholder="e.g., TX or ON" maxlength="4">
    ...
    <input type="text" id="destination_state" name="destination_state" required placeholder="e.g., OH or QC" maxlength="4">
